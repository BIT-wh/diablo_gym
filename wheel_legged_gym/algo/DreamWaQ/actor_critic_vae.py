...
class ActorCritic_VAE(nn.Module):
    def __init__(
        ...
        # print('encoder_hidden_dims',encoder_hidden_dims)
        # print('decoder_hidden_dims',decoder_hidden_dims)
        ...
        estimated_vel = 3
        self.actor = Actor(
            input_size=num_obs + num_latent + estimated_vel,    #disable VAE
            # input_size = num_obs,
    ...
    def act_inference(self, obs_dict):
        z ,vel,latent_mu, vel_mu = self.vae.inference(obs_dict["obs_history"])
    ...
    def evaluate(self, obs, privileged_observations):
        ...
        # input = torch.cat([privileged_observations,vel],dim=-1)
